...
namespace GraphenEditor.GameProject
{
    ...
    class NewProject : ViewModelBase
    {
        ...
        private readonly string _templatePath = @"C:\Users\FORYOUCOM\Desktop\game engine\Graphen\GraphenEditor\ProjectTemplates";
        ...
        private string _projectPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\GraphenProjects\";
